# Generated by Django 3.2 on 2024-02-17 13:29
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('confirmation_code', models.CharField(default='A6snNjrwgj', max_length=10, verbose_name='Код подтверждения')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=256, verbose_name='Название')),
                ('year', models.IntegerField(validators=[django.core.validators.MaxValueValidator(limit_value=2024)], verbose_name='Год выпуска')),
